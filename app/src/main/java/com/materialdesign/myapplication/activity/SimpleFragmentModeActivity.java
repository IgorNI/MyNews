...
public class SimpleFragmentModeActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        context = SimpleFragmentModeActivity.this;
...
public void onConnected(Bundle bundle) {
    ...
    if (mLastLocation != null) {
        ...
        String address = getAddress(SimpleFragmentModeActivity.this, mLastLocation.getLatitude(), mLastLocation.getLongitude());
 ...
 * @return
 */
public static String getAddress(SimpleFragmentModeActivity context, double latitude, double longitude) {
